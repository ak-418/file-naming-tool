function mlines(x) {
  ...
  if (lines.length > 16) alert("More than 15 records detected.");
  var p,
    n = 0;
...
function langchange(x) {
  ...
  if (mo == "") eptitle = dash[17];

  if (eptitle !== null) var z = eptitle.match(/\[[0-9A-Z]*[0-9]+\/*[0-9]*\]/);
  ...
  else if (ds.match(/Chinese Simplified/))
    document.getElementById(l).selectedIndex = 4;
  else if (ds.match(/Chinese Traditional/))
    document.getElementById(l).selectedIndex = 5;
  ...
  else if (ds.match(/French [Parisian\/Euro]/))
    document.getElementById(l).selectedIndex = 13;
  else if (ds.match(/French [Canadian\/Quebecois]/))
    document.getElementById(l).selectedIndex = 14;
  ...
  else if (ds.match(/Indonesian/))
    document.getElementById(l).selectedIndex = 20;
  ...
  else if (ds.match(/Norwegian Nynorsk/))
    document.getElementById(l).selectedIndex = 27;
  else if (ds.match(/Norwegian Bokmal/))
    document.getElementById(l).selectedIndex = 28;
  else if (ds.match(/Polish/)) document.getElementById(l).selectedIndex = 29;
  else if (ds.match(/Portuguese Brazilian|Portuguese \(BRZ\)/))
    document.getElementById(l).selectedIndex = 30;
  else if (ds.match(/Portuguese European/))
    document.getElementById(l).selectedIndex = 31;
  ...
  else if (ds.match(/Spanish CST|Spanish Castilian|\(CST\)/))
    document.getElementById(l).selectedIndex = 36;
  else if (ds.match(/Latin Spanish|Spanish \(LAS\)|LAS/))
    document.getElementById(l).selectedIndex = 37;
  ...
  else if (ds.match(/Vietnamese/))
    document.getElementById(l).selectedIndex = 43;
  else if (ds.match(/English/)) document.getElementById(l).selectedIndex = 10;
  else if (ds.match(/English (UK)/))
    document.getElementById(l).selectedIndex = 11;
...
function myFunction(x) {
  ...
  if (document.getElementById(pq).checked) var pq = "_PenQueries";
  else pq = "";
  ...
  if (dec == 0) {
    ...
    if (z !== null) {
      ...
      if (epname !== "") epname = epname.replace(/ /g, "");
      ...
      if (seasonnumber !== "") {
        if (seasonnumber.length < 2) seasonnumber = "0" + seasonnumber;
        if (ep1.length < 2 && ep1 !== 0) ep1 = "0" + ep1;
        ...
        if (epname != "" || shownamefull[1].length < 1) {
          ...
          if (/_Season[0-9]{2}/.test(fnam)) fnam = fnam.replace(/Season/, "S");
          ...
          if (ep1 == 0) alert("Episode number not entered.");
        ...
        if (sn.length > 5) seasonnumber = 5789635; //random number

        if (ep1.length < 2) ep1 = "0" + ep1;
        ...
        if (/_Episode[0-9]{2}/.test(fnam)) fnam = fnam.replace(/Episode/, "E");
        else if (/_Episode[0-9]{1}/.test(fnam))
          fnam = fnam.replace(/Episode/, "E0");
        fnam = fnam.replace(/_+/g, "_");
  ...
  if (dec == 1) {
    ...
    var snu = "S",
      enu = "E";
    if (season.length < 2) snu = "S0";
    if (ep1.length < 2) enu = "E0";
    if (ename !== "") ename = ename + us;
    if (season !== "") season = snu + season + us;
    if (ep1 !== "") ep1 = enu + ep1 + us;
    ...
    if (mo == "") alert("Note: MO# not entered.");
  }
